...
module.exports.run = async (lanisBot, message, args) => {
    ...
    let faqMessage = new Discord.MessageEmbed()
        ...
        .addBlankField()
        .addField("Q: How do I join organized raids once I am verified?", "A: Raids will be announced in <#379779029479194624>.  Join a raiding channel that is active (It is specified in the AFK Check) and react to the bot with <:cultist:397924622928052230>, <:LHvoid:431284547012001809>, or one of the classes you are bringing, listed in the reactions.")
        .addBlankField()
